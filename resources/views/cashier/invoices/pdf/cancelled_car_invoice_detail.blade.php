...
$storageTotal = $invoiceData->fine_total_cost_aed;
$subTotal =  $invoiceData->fine_total_cost_aed + $invoiceData->advanced;
...
<div class="print-content {{app('translator')->getLocale()}}">
    ...
    <table style="border:1px solid">
        ...
        <tr>
            <td>{{__('date')}}: <span class="ltr">{{date('j F, Y h:i:sa', strtotime($invoiceData->create_date))}}</span></td>
    ...
    <table class="table-bordered transactions">
        ...
        <tr>
            <td>{{__('vehicle sale price')}}</td>
            <td class="text-center">{{Helpers::format_money( $invoiceData->car_cost_aed)}}</td>
            <td></td>
        </tr>
